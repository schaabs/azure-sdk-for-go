...
const (
	...
	ExpressRouteCircuitSkuTierTransport ExpressRouteCircuitSkuTierType = "Transport"
)
...
type ExpressRouteCircuitSku struct {
	...
	Name *string `json:"name,omitempty"`
	// Tier - The tier of the SKU. Possible values are 'Standard' and 'Premium'. Possible values include: 'Standard', 'Premium', 'Transport', 'None'
