...
// CreateOrUpdate the Put LoadBalancer operation creates/updates a LoadBalancer This method may poll for completion.
...
// Delete the delete loadbalancer operation deletes the specified loadbalancer. This method may poll for completion.
// Polling can be canceled by passing the cancel channel argument. The channel will be used to cancel polling and any
// outstanding HTTP requests.
//
...
//
// resourceGroupName is the name of the resource group. loadBalancerName is the name of the loadBalancer.
func (client LoadBalancersClient) Get(ctx context.Context, resourceGroupName string, loadBalancerName string) (*LoadBalancer, error) {
...
func (client LoadBalancersClient) getPreparer(resourceGroupName string, loadBalancerName string) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}"
