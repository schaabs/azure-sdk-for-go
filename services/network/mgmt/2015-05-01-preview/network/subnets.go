...
// CreateOrUpdate the Put Subnet operation creates/updates a subnet in thespecified virtual network This method may
...
func (client SubnetsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, virtualNetworkName string, subnetName string, subnetParameters Subnet) (*Subnet, error) {
	if err := validate([]validation{
		{targetValue: subnetParameters,
			constraints: []constraint{{target: "subnetParameters.SubnetPropertiesFormat", name: null, rule: false,
				chain: []constraint{{target: "subnetParameters.SubnetPropertiesFormat.AddressPrefix", name: null, rule: true, chain: nil}}}}}}); err != nil {
		return nil, err
	}
...
// Delete the delete subnet operation deletes the specified subnet. This method may poll for completion. Polling can be
...
// resourceGroupName is the name of the resource group. virtualNetworkName is the name of the virtual network.
// subnetName is the name of the subnet.
func (client SubnetsClient) Get(ctx context.Context, resourceGroupName string, virtualNetworkName string, subnetName string) (*Subnet, error) {
...
func (client SubnetsClient) getPreparer(resourceGroupName string, virtualNetworkName string, subnetName string) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualnetworks/{virtualNetworkName}/subnets/{subnetName}"
