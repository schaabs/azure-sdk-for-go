...
//
// resourceGroupName is the name of the resource group. routeTableName is the name of the route table.
func (client RouteTablesClient) Get(ctx context.Context, resourceGroupName string, routeTableName string) (*RouteTable, error) {
...
func (client RouteTablesClient) getPreparer(resourceGroupName string, routeTableName string) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeTables/{routeTableName}"
