...
//
// resourceGroupName is the name of the resource group. circuitName is the name of the circuit.
func (client ExpressRouteCircuitsClient) ListArpTable(ctx context.Context, resourceGroupName string, circuitName string) (*ExpressRouteCircuitsArpTableListResult, error) {
...
func (client ExpressRouteCircuitsClient) listArpTablePreparer(resourceGroupName string, circuitName string) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}arpTable"
	req, err := pipeline.NewRequest("GET", u, nil)
	if err != nil {
		return req, pipeline.NewError(err, "failed to create request")
	}
...
//
// resourceGroupName is the name of the resource group. circuitName is the name of the circuit.
func (client ExpressRouteCircuitsClient) ListRoutesTable(ctx context.Context, resourceGroupName string, circuitName string) (*ExpressRouteCircuitsRoutesTableListResult, error) {
...
func (client ExpressRouteCircuitsClient) listRoutesTablePreparer(resourceGroupName string, circuitName string) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}routesTable"
	req, err := pipeline.NewRequest("GET", u, nil)
	if err != nil {
		return req, pipeline.NewError(err, "failed to create request")
	}
...
func (client ExpressRouteCircuitsClient) ListStats(ctx context.Context, resourceGroupName string, circuitName string) (*ExpressRouteCircuitsStatsListResult, error) {
	req, err := client.listStatsPreparer(resourceGroupName, circuitName)
	if err != nil {
		return nil, err
	}
	resp, err := client.Pipeline().Do(ctx, responderPolicyFactory{responder: client.listStatsResponder}, req)
	if err != nil {
		return nil, err
	}
	return resp.(*ExpressRouteCircuitsStatsListResult), err
}

// listStatsPreparer prepares the ListStats request.
func (client ExpressRouteCircuitsClient) listStatsPreparer(resourceGroupName string, circuitName string) (pipeline.Request, error) {
	u := client.url
...
// listStatsResponder handles the response to the ListStats request.
func (client ExpressRouteCircuitsClient) listStatsResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
	result := &ExpressRouteCircuitsStatsListResult{rawResponse: resp.Response()}
	if err != nil {
		return result, err
	}
	defer resp.Response().Body.Close()
