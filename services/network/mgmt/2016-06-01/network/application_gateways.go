...
// CreateOrUpdate the Put ApplicationGateway operation creates/updates a ApplicationGateway This method may poll for
...
// parameters is parameters supplied to the create/delete ApplicationGateway operation
...
// Delete the delete ApplicationGateway operation deletes the specified application gateway. This method may poll for
// completion. Polling can be canceled by passing the cancel channel argument. The channel will be used to cancel
// polling and any outstanding HTTP requests.
//
...
// Network resource provider. This method may poll for completion. Polling can be canceled by passing the cancel
