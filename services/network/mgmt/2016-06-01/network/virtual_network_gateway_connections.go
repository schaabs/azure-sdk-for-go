...
// network gateway connection. parameters is parameters supplied to the Begin Create or update Virtual Network Gateway
...
func (client VirtualNetworkGatewayConnectionsClient) GetSharedKey(ctx context.Context, resourceGroupName string, connectionSharedKeyName string) (*ConnectionSharedKeyResult, error) {
	...
	return resp.(*ConnectionSharedKeyResult), err
}

// getSharedKeyPreparer prepares the GetSharedKey request.
func (client VirtualNetworkGatewayConnectionsClient) getSharedKeyPreparer(resourceGroupName string, connectionSharedKeyName string) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/connections/{connectionSharedKeyName}/sharedkey"
	req, err := pipeline.NewRequest("GET", u, nil)
	if err != nil {
		return req, pipeline.NewError(err, "failed to create request")
	}
...
func (client VirtualNetworkGatewayConnectionsClient) getSharedKeyResponder(resp pipeline.Response) (pipeline.Response, error) {
	...
	result := &ConnectionSharedKeyResult{rawResponse: resp.Response()}
	if err != nil {
		return result, err
	}
	defer resp.Response().Body.Close()
