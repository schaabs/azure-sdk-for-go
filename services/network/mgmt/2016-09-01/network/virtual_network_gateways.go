...
func (client VirtualNetworkGatewaysClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, virtualNetworkGatewayName string, parameters VirtualNetworkGateway) (*VirtualNetworkGateway, error) {
	if err := validate([]validation{
		{targetValue: parameters,
			constraints: []constraint{{target: "parameters.VirtualNetworkGatewayPropertiesFormat", name: null, rule: true,
				chain: []constraint{{target: "parameters.VirtualNetworkGatewayPropertiesFormat.IPConfigurations", name: null, rule: true, chain: nil}}}}}}); err != nil {
		return nil, err
	}
