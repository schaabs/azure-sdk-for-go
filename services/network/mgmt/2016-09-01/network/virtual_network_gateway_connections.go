		...
		{targetValue: parameters,
			constraints: []constraint{{target: "parameters.VirtualNetworkGatewayConnectionPropertiesFormat", name: null, rule: true,
				chain: []constraint{{target: "parameters.VirtualNetworkGatewayConnectionPropertiesFormat.VirtualNetworkGateway1", name: null, rule: true,
					chain: []constraint{{target: "parameters.VirtualNetworkGatewayConnectionPropertiesFormat.VirtualNetworkGateway1.VirtualNetworkGatewayPropertiesFormat", name: null, rule: true,
						chain: []constraint{{target: "parameters.VirtualNetworkGatewayConnectionPropertiesFormat.VirtualNetworkGateway1.VirtualNetworkGatewayPropertiesFormat.IPConfigurations", name: null, rule: true, chain: nil}}},
					}},
					{target: "parameters.VirtualNetworkGatewayConnectionPropertiesFormat.VirtualNetworkGateway2", name: null, rule: false,
						chain: []constraint{{target: "parameters.VirtualNetworkGatewayConnectionPropertiesFormat.VirtualNetworkGateway2.VirtualNetworkGatewayPropertiesFormat", name: null, rule: true,
							chain: []constraint{{target: "parameters.VirtualNetworkGatewayConnectionPropertiesFormat.VirtualNetworkGateway2.VirtualNetworkGatewayPropertiesFormat.IPConfigurations", name: null, rule: true, chain: nil}}},
						}},
					{target: "parameters.VirtualNetworkGatewayConnectionPropertiesFormat.LocalNetworkGateway2", name: null, rule: false,
						chain: []constraint{{target: "parameters.VirtualNetworkGatewayConnectionPropertiesFormat.LocalNetworkGateway2.LocalNetworkGatewayPropertiesFormat", name: null, rule: true,
							chain: []constraint{{target: "parameters.VirtualNetworkGatewayConnectionPropertiesFormat.LocalNetworkGateway2.LocalNetworkGatewayPropertiesFormat.LocalNetworkAddressSpace", name: null, rule: true, chain: nil}}},
						}},
				}}}}}); err != nil {
		return nil, err
	}
