...
func (client LocalNetworkGatewaysClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, localNetworkGatewayName string, parameters LocalNetworkGateway) (*LocalNetworkGateway, error) {
	if err := validate([]validation{
		{targetValue: parameters,
			constraints: []constraint{{target: "parameters.LocalNetworkGatewayPropertiesFormat", name: null, rule: true,
				chain: []constraint{{target: "parameters.LocalNetworkGatewayPropertiesFormat.LocalNetworkAddressSpace", name: null, rule: true, chain: nil}}}}}}); err != nil {
		return nil, err
	}
