...
func New(subscriptionID string, resourceGroupName string, accountName string) BaseClient {
	return NewWithBaseURI(DefaultBaseURI, subscriptionID, resourceGroupName, accountName)
}

// NewWithBaseURI creates an instance of the BaseClient client.
func NewWithBaseURI(baseURI string, subscriptionID string, resourceGroupName string, accountName string) BaseClient {
	return BaseClient{
