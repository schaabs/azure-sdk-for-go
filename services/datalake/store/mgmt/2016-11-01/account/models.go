...
func (future AccountsCreateFuture) Result(client AccountsClient) (dlsa DataLakeStoreAccount, err error) {
	var done bool
	...
	if !done {
		return dlsa, azure.NewAsyncOpIncompleteError("account.AccountsCreateFuture")
	}
...
// Result returns the result of the asynchronous operation.
// If the operation has not completed it will return an error.
func (future AccountsUpdateFuture) Result(client AccountsClient) (dlsa DataLakeStoreAccount, err error) {
	var done bool
	done, err = future.Done(client)
	if err != nil {
	...
	if !done {
		return dlsa, azure.NewAsyncOpIncompleteError("account.AccountsUpdateFuture")
	}
	if future.PollingMethod() == azure.PollingLocation {
...
func (cdlsap *CreateDataLakeStoreAccountParameters) UnmarshalJSON(body []byte) error {
	...
	v = m["properties"]
	if v != nil {
		var properties CreateDataLakeStoreAccountProperties
		err = json.Unmarshal(*m["properties"], &properties)
		if err != nil {
			return err
		}
		cdlsap.CreateDataLakeStoreAccountProperties = &properties
	}
...
func (udlsap *UpdateDataLakeStoreAccountParameters) UnmarshalJSON(body []byte) error {
	...
	if v != nil {
		...
		udlsap.UpdateDataLakeStoreAccountProperties = &properties
	}
