...
func (future AccountsCreateFuture) Result(client AccountsClient) (dlaa DataLakeAnalyticsAccount, err error) {
	var done bool
	done, err = future.Done(client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "account.AccountsCreateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		return dlaa, azure.NewAsyncOpIncompleteError("account.AccountsCreateFuture")
	}
	if future.PollingMethod() == azure.PollingLocation {
		dlaa, err = client.CreateResponder(future.Response())
		if err != nil {
			err = autorest.NewErrorWithError(err, "account.AccountsCreateFuture", "Result", future.Response(), "Failure responding to request")
		}
		return
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "account.AccountsCreateFuture", "Result", resp, "Failure sending request")
		return
	}
	dlaa, err = client.CreateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "account.AccountsCreateFuture", "Result", resp, "Failure responding to request")
	}
	return
}
...
func (future AccountsDeleteFuture) Result(client AccountsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "account.AccountsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		return ar, azure.NewAsyncOpIncompleteError("account.AccountsDeleteFuture")
	}
	if future.PollingMethod() == azure.PollingLocation {
		ar, err = client.DeleteResponder(future.Response())
		if err != nil {
			err = autorest.NewErrorWithError(err, "account.AccountsDeleteFuture", "Result", future.Response(), "Failure responding to request")
		}
		return
	}
	var resp *http.Response
	resp, err = autorest.SendWithSender(client, autorest.ChangeToGet(future.req),
		autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if err != nil {
		err = autorest.NewErrorWithError(err, "account.AccountsDeleteFuture", "Result", resp, "Failure sending request")
		return
	}
	ar, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "account.AccountsDeleteFuture", "Result", resp, "Failure responding to request")
	}
	return
}
...
// Result returns the result of the asynchronous operation.
// If the operation has not completed it will return an error.
func (future AccountsUpdateFuture) Result(client AccountsClient) (dlaa DataLakeAnalyticsAccount, err error) {
	var done bool
	done, err = future.Done(client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "account.AccountsUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		return dlaa, azure.NewAsyncOpIncompleteError("account.AccountsUpdateFuture")
	}
	if future.PollingMethod() == azure.PollingLocation {
		dlaa, err = client.UpdateResponder(future.Response())
		if err != nil {
			err = autorest.NewErrorWithError(err, "account.AccountsUpdateFuture", "Result", future.Response(), "Failure responding to request")
		}
		return
	}
	var resp *http.Response
	resp, err = autorest.SendWithSender(client, autorest.ChangeToGet(future.req),
		autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if err != nil {
		err = autorest.NewErrorWithError(err, "account.AccountsUpdateFuture", "Result", resp, "Failure sending request")
		return
	}
	dlaa, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "account.AccountsUpdateFuture", "Result", resp, "Failure responding to request")
	}
	return
}
...
func (cdlaap *CreateDataLakeAnalyticsAccountParameters) UnmarshalJSON(body []byte) error {
	...
	v = m["properties"]
	if v != nil {
		var properties CreateDataLakeAnalyticsAccountProperties
		err = json.Unmarshal(*m["properties"], &properties)
		if err != nil {
			return err
		}
		cdlaap.CreateDataLakeAnalyticsAccountProperties = &properties
	}
...
func (dlsai *DataLakeStoreAccountInformation) UnmarshalJSON(body []byte) error {
	...
	v = m["properties"]
	if v != nil {
		var properties DataLakeStoreAccountInformationProperties
		err = json.Unmarshal(*m["properties"], &properties)
		if err != nil {
			return err
		}
		dlsai.DataLakeStoreAccountInformationProperties = &properties
	}
...
func (sai *StorageAccountInformation) UnmarshalJSON(body []byte) error {
	...
	v = m["properties"]
	if v != nil {
		var properties StorageAccountInformationProperties
		err = json.Unmarshal(*m["properties"], &properties)
		if err != nil {
			return err
		}
		sai.StorageAccountInformationProperties = &properties
	}
...
func (udlaap *UpdateDataLakeAnalyticsAccountParameters) UnmarshalJSON(body []byte) error {
	...
	if v != nil {
		...
		udlaap.UpdateDataLakeAnalyticsAccountProperties = &properties
	}
